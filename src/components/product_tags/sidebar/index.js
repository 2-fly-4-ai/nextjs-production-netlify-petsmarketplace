                        ...
                        >
                          {!isEmpty(brand?.nodes[0]?.uri) ? (
                            <Link href={brand?.nodes[0]?.uri}>
                              <a
                                className="text-gray-600 dark:text-gray-400  capitalize font-medium border-2 focus:ring-2 focus:outline-none focus:ring-primary-300 focus:rounded-full bg-white dark:bg-gray-800 dark:border-gray-700 border-gray-300 rounded-full px-2 overflow-hidden text-sm py-0.5 pb-1.5  hover:bg-gray-600 "
                                dangerouslySetInnerHTML={{
