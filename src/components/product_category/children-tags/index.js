        ...
        <ul className="flex flex-wrap align items-start gap-1 p-2">
          {page_tags.map((tag) => (
            ...
            >
              <Link href={tag.uri}>
                <a
                  className="text-gray-600 border-2 focus:ring-2 focus:outline-none focus:ring-primary-300 focus:rounded-full border-gray-300 rounded-full px-2 text-sm py-0.5 pb-1.5 hover:bg-gray-200"
